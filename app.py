...
# Classify fresh/rotten function
def ret_fresh(res):
...
def evaluate_rotten_vs_fresh(image_path):
    ...
    model = load_model('C:/Users/PMLS/Desktop/Api/api/rottenvsfresh98pval.h5')
...
def ident_type(img): # Identify type of fruit/veg using PyTorch
    ...
    model.load_state_dict(torch.load('C:/Users/PMLS/Desktop/Api/api/modelforclass.pth', map_location=torch.device('cpu')))
    model.eval()
